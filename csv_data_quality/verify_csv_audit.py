...
def main():
    ...
    test_files = [
        os.path.join(test_dir, "structural_issues.csv"),
        os.path.join(test_dir, "unquoted_multiline.csv")
    ]
    ...
    for test_file in test_files:
        ...
        try:
            ...
            print(f"Healed Rows: {summary.healed_rows}")
            ...
            print(f"Audit failed for {test_file}: {e}")
            import traceback
            traceback.print_exc()
    
        print(f"\n--- End Audit for {test_file} ---\n")
